          ...
          <div className="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
              <ul className="navbar-nav">
                    ...
                    <div className="hidden">
                      <ul className="ul-item-list">
                        <li className="li-list-item">
                          <Link to="/hoat-dong-ngoai-khoa" className="a-li-list-item">Ngoại khóa</Link>
                          </li>
                        <li className="li-list-item">
                          <Link to="/cau-lac-bo-vo-thuat" className="a-li-list-item">CLB Võ thuật</Link>
                          </li>
                        <li className="li-list-item">
                          <Link to="/cau-lac-bo-cuu-hoc-vien" className="a-li-list-item">CLB Cựu học viên</Link>
                          </li>
                      </ul>
                    </div>
                  </NavLink >
                ...
                <li class="nav-item menu-item">
                  <NavLink className="NavLink" to="/DangKy" activeStyle={{ background: "#e69032", color: "#fffbf2", borderRadius: "5px" }}
                    className="nav-link navlinka" activeClassName="active">
                    Đăng Ký HỌC 
                  {/* <div className="hidden ">
                      <ul className="ul-item-list">
